  ...
  return (
    <main className="settings-page">
      ...
      <section className="settings-grid">
        ...
        <div className="form-card"><h2>Renderizacao</h2><p className="muted">FFmpeg.wasm em worker para projetos pequenos, com fallback do navegador para casos maiores.</p><label className="check-row"><input type="checkbox" defaultChecked /> Usar worker para tarefas pesadas</label></div>
