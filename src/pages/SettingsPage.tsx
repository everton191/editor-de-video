  ...
  return (
    <main className="settings-page">
      ...
      <section className="settings-grid">
        ...
        <div className="form-card"><h2>Renderizacao</h2><p className="muted">Preparado para FFmpeg.wasm no navegador e FFmpeg local em uma futura versao desktop.</p><label className="check-row"><input type="checkbox" defaultChecked /> Usar worker para tarefas pesadas</label></div>
